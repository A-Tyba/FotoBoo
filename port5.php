...
<header class="w3-display-container w3-content w3-center" style="max-width:1500px" style="color:#000000">
  <img class="w3-image" src="images/port5-1.jpg" alt="Me" width="1500" height="600" style="color:#000000">
  <div  class="w3-display-middle w3-padding-large w3-border w3-wide w3-text-light-grey w3-center" style="color:#000000">
    <h1 class="w3-hide-medium w3-hide-small w3-xxxlarge" style="color:#000000"><?php echo $name_fill ?></h1>
    <h5 class="w3-hide-large" style="white-space:nowrap" style="color:#000000"><?php echo $name_fill ?></h5>
    <h3 class="w3-hide-medium w3-hide-small" style="color:#000000">ADVERTISEMENT PHOTOGRAPHER</h3>
  </div>
  
  <!-- Navbar (placed at the bottom of the header image) -->
  <div class="w3-bar w3-yellow w3-round w3-display-bottommiddle w3-hide-small" style="bottom:-16px">
...
<div class="w3-content w3-padding-large w3-margin-top" id="portfolio">
  ...
  <div class="w3-red w3-padding-large w3-padding-32 w3-margin-top" id="bio">
  ...
  <!-- Biography -->
  <div class="w3-orange w3-padding-large w3-padding-32 w3-margin-top" id="bio">
  ...
  <div class="w3-pink w3-padding-large w3-padding-32 w3-margin-top" id="portfolio">
  <h3 class="w3-center">Portfolio</h3>
  <hr>
  <img src="images/port5-2.jpg" alt="Ocean" class="w3-image" width="1000" height="500">
  <img src="images/port5-3.jpg" alt="Ocean II" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port5-4.jpg" alt="Falls" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port5-5.jpg" alt="Skies" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port5-6.jpg" alt="Mountains" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port5-7.jpg" alt="Ocean" class="w3-image" width="1000" height="500">
  <img src="images/port5-8.jpg" alt="Ocean II" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port5-9.jpg" alt="Falls" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port5-10.jpg" alt="Skies" class="w3-image w3-margin-top" width="1000" height="500">
  </div>
...
<!-- End page content -->
  ...
  <div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" id="contact">
    ...
    <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="number" name="photographer_id" id="photographer_id" value="5">
      </div>
