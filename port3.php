...
<div class="w3-content" style="max-width:500px;margin-top:46px">
  ...
  <div class="mySlides w3-display-container w3-center">
    <img src="images/p3.jpg" height=700 style="width:100%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <h3><?php echo $name_fill ?></h3>
      <p><b>Travel Photographer</b></p>   
    </div>
  </div>
    ...
    <div class="w3-container w3-content w3-padding">
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          ...
          <img width="720" height="480" src="images/port3-1.jpg" alt="New York"  class="w3-hover-opacity">
          <img width="720" height="480" src="images/port3-2.jpg" alt="New York"  class="w3-hover-opacity">
          <img width="720" height="480" src="images/port3-3.jpg" alt="New York"  class="w3-hover-opacity">
          <img width="720" height="480" src="images/port3-4.jpg" alt="New York"  class="w3-hover-opacity">
          <img width="720" height="480" src="images/port3-5.jpg" alt="New York"  class="w3-hover-opacity">
          <img width="720" height="480" src="images/port3-6.jpg" alt="New York"  class="w3-hover-opacity">
          <img width="720" height="480" src="images/port3-7.jpg" alt="New York"  class="w3-hover-opacity">
...
window.onclick = function(event) {
 ...
 <div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" width=800 id="contact">
    ...
    <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="number" name="photographer_id" id="photographer_id" value="3">
      </div>
