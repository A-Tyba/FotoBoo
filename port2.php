...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    ...
    <h3 class="w3-padding-16 w3-text-light-grey">Wedding Photographer</h3>
    <img src="images/p2_bw.jpg" alt="boy" class="w3-image" width="400" height="400">
  </header>
  ...
  <div class="w3-padding-64 w3-content" id="portfolio">
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half">
        <img src="images/port2-7.jpg" style="width:100%">
        <img src="images/port2-6.jpg" style="width:100%">
        <img src="images/port2-5.jpg" style="width:100%">
        <img src="images/port2-8.jpg" style="width:100%">
      </div>

      <div class="w3-half">
        <img src="images/port2-4.jpg" style="width:100%">
        <img src="images/port2-3.jpg" style="width:100%">
        <img src="images/port2-2.jpg" style="width:100%">
        <img src="images/port2-1.jpg" style="width:100%">
      </div>
    <!-- End photo grid -->
    </div>
    ...
    foreach(array_reverse($registration) as $reg){
      //$int_value = intval( $string );
        ...
        if($check_id==$id && $count!=10){
            ...
            $star2=intval(htmlspecialchars($reg['star']));
            $count++;
