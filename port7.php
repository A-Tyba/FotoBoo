...
<header class="w3-display-container w3-content w3-center" style="max-width:1500px">
  <img class="w3-image" src="images/port7-1.jpg" alt="Me" width="1000" height="300">
  <div class="w3-display-middle w3-padding-large w3-border w3-wide w3-text-light-grey w3-center">
    <h1 class="w3-hide-medium w3-hide-small w3-xxxlarge"><?php echo $name_fill ?></h1>
    <h5 class="w3-hide-large" style="white-space:nowrap"><?php echo $name_fill ?></h5>
    <h3 class="w3-hide-medium w3-hide-small">ASTROPHOTOGRAPHER</h3>
  </div>
...
<div class="w3-content w3-padding-large w3-margin-top"  id="portfolio">
  ...
  <img src="images/port7-2.jpg" alt="Ocean" class="w3-image" width="1000" height="500">
  <img src="images/port7-3.jpg" alt="Ocean II" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port7-4.jpg" alt="Falls" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port7-5.jpg" alt="Skies" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port7-6.jpg" alt="Mountains" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port7-7.jpg" alt="Falls" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port7-8.jpg" alt="Skies" class="w3-image w3-margin-top" width="1000" height="500">

  </div>

    <!-- Contact -->
    <div class="w3-black w3-padding-large w3-padding-32 w3-margin-top" id="reviews">
...
<!-- End page content -->
  ...
  <div class="w3-black w3-padding-large w3-padding-32 w3-margin-top" id="contact">
    ...
    <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="number" name="photographer_id" id="photographer_id" value="7">
      </div>
