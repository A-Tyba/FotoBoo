...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
  ...
  <img class="w3-center" src="images/p4.jpg" alt="Photo of Me" width="500" height="700"><br><br>
    <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">I am <?php echo $name_fill ?></span><br><br>
    <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">Sports & Fitness Photographer</span>
  </div>
</div>

  <!-- Stars and Review count -->
  <div class="w3-white w3-padding-large w3-padding-32 w3-margin-top" id="bio">
...
<div class="w3-content w3-container w3-padding-64" id="portfolio">
  ...
  <div class="w3-yellow w3-padding-large w3-padding-32 w3-margin-top" id="portfolio">
  
  <img src="images/port4-1.jpg"  class="w3-image" width="1000" height="500">
  <img src="images/port4-2.jpg" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port4-3.jpg"  class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port4-4.jpg"  class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port4-5.jpg"  class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port4-6.jpg"  class="w3-image" width="1000" height="500">
  <img src="images/port4-7.jpg"  class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port4-8.jpg"  class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port4-9.jpg" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port4-10.jpg"  class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port4-11.jpg"  class="w3-image w3-margin-top" width="1000" height="500">
  </div>
...
<div class="w3-content w3-container w3-padding-64" id="contact">
  ...
  <div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" id="contact">
    ...
    <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="number" name="photographer_id" id="photographer_id" value="4">
      </div>
