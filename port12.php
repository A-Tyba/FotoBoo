...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center"  id="home">
    ...
    <h3 class="w3-padding-16 w3-text-light-grey">Architectural Photographer</h3>
    <img src="images/p12.jpg" alt="boy" class="w3-image" width="400" height="400">
  </header>
  ...
  <div class="w3-padding-64 w3-content" id="portfolio">
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half">
        <img src="images/port12-1.jpg" style="width:100%">
        <img src="images/port12-2.jpg" style="width:100%">
        <img src="images/port12-3.jpg" style="width:100%">
        <img src="images/port12-4.jpg" style="width:100%">
        <img src="images/port12-5.jpg" style="width:100%">
      </div>

      <div class="w3-half">
        <img src="images/port12-6.jpg" style="width:100%">
        <img src="images/port12-7.jpg" style="width:100%">
        <img src="images/port12-8.jpg" style="width:100%">
        <img src="images/port12-9.jpg" style="width:100%">
        <img src="images/port12-10.jpg" style="width:100%">
        <img src="images/port12-11.jpg" style="width:100%">
      </div>
    <!-- End photo grid -->
    </div>
  ...
  <div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" id="contact">
    ...
    <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="number" name="photographer_id" id="photographer_id" value="12">
      </div>
