...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center"  id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small" style="color:white;">I'm <?php echo " ".$name_fill ?> </span></h1>
    <h3 class="w3-padding-16 w3-text-light-grey">Corporate Photographer</h3>
    <img src="images/p6.jpg" alt="boy" class="w3-image" width="400" height="400">
  </header>

    <!-- Stars and Review count -->
    <div class="w3-blue w3-padding-large w3-padding-32 w3-margin-top" id="bio">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="biography">
    ...
    <p style="color:white;" > <?php echo $bio_fill ?>
    </p>
  ...
  <div class="w3-padding-64 w3-content" id="portfolio">
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half">
        <img src="images/port6-1.jpg" style="width:100%">
        <img src="images/port6-2.jpg" style="width:100%">
        <img src="images/port6-3.jpg" style="width:100%">
        <img src="images/port6-4.jpg" style="width:100%">
        <img src="images/port6-9.jpg" style="width:100%">
      </div>

      <div class="w3-half">
        <img src="images/port6-5.jpg" style="width:100%">
        <img src="images/port6-6.jpg" style="width:100%">
        <img src="images/port6-7.jpg" style="width:100%">
        <img src="images/port6-8.jpg" style="width:100%">
        <img src="images/port6-10.jpg" style="width:100%">
      </div>
    <!-- End photo grid -->
    </div>
  ...
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
    ...
    <div class="w3-section">
      ...
      <i class="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"  > </i></p>
      <p style="color:white;">  <?php echo $contact_fill ?>  </p>
    </div><br>
  ...
  <div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" id="contact">
    ...
    <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="number" name="photographer_id" id="photographer_id" value="6">
      </div>
