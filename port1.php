...
<header class="w3-display-container w3-content w3-center" style="max-width:1500px">
  <img class="w3-image" src="images/port1-1.jpg" alt="Me" width="1500" height="600">
  <div class="w3-display-middle w3-padding-large w3-border w3-wide w3-text-light-grey w3-center">
    ...
    <h3 class="w3-hide-medium w3-hide-small">NATURE PHOTOGRAPHER</h3>
  </div>
...
<div class="w3-content w3-padding-large w3-margin-top"  id="portfolio">
  ...
  <div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" id="bio">
  ...
  <div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" id="portfolio">
  <h3 class="w3-center">Portfolio</h3>
  <img src="images/port1-2.jpg" alt="Ocean" class="w3-image" width="1000" height="500">
  <img src="images/port1-3.jpg" alt="Ocean II" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port1-4.jpg" alt="Falls" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port1-5.jpg" alt="Skies" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="images/port1-6.jpg" alt="Mountains" class="w3-image w3-margin-top" width="1000" height="500">
  </div>
...
<!-- End page content -->
  ...
  <div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" id="contact">
    ...
    <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="number" name="photographer_id" id="photographer_id" value="1">
      </div>
